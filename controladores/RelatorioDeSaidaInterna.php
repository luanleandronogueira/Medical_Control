...
if(!empty($_POST)){
    ...
    $html .= "<center>";
    // $html .= "<img width='200px' src='http://l3tecnologia.app.br/medicalcontrol/pm_paranatama/assets/img/medical_control_vetor.png'>";
    $html .= "<h4 class='text-center small'>Relatório de Saída Interna</h4>";
    $html .= " </center>";
    ...
    foreach($saidas as $saida) {
        ...
        $html .= "<tr>";
            ...
            $html .= "<td><small>" . $saida['nome_subsetor'] . " - " . $saida['nome_estoque'] . "</small></td>";
