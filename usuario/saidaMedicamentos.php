...
<body>
  ...
  <main id="main" class="main">
    <section class="section">
      <div class="row">
        <div class="card">
          <center><h5 class="card-title">Dar Saída em Medicamentos</h5></center>
        </div>
          ...
          <div class="row">
              ...
              <div class="card">        
                <div class="card-body">
                  <div class="mt-3">
                    ...
                    <select class="form-control" name="nome_saida" id="">
            ...
            <div class="col-lg-6">
              <div class="card">        
                <div class="card-body">
                  <div class="mt-3">
                    <label for="">Nº do Cartão do SUS:</label>
                    <input type="number" required  name="sus_saida" class="form-control"> 
                    </br>
              ...
              <div class="card">        
                <div class="card-body">
                  <div class="mt-3">
                    ...
                    <textarea class="form-control" name="observacao_saida" id="" cols="8" rows="5"></textarea>
