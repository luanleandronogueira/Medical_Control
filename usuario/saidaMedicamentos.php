        ...
        <section class="section">
            <div class="row">
                <div class="card">
                  ...
                  <?php } ?>
                        <form action="../controladores/Saida.php" method="post">
                            <center>
                            ...
                            <hr>
                            <div class="row">
                                <center><h5 class="card-title">Estoque Disponível</h5></center>
                                        ...
                                        <?php foreach ($remedio as $R) { ?>
                                            <tr>
                                                <td>
                                                    ...
                                                    <input class="form-check-input" type="checkbox" name="remedios_selecionados[]" value="<?= $R['id_remedio'] ?>">
                                                </td>
                                                <td><?= $R['id_remedio'] ?></td>
